...
DEPS="gdal=$GDAL_VERSION numpy scipy matplotlib netcdf4 h5py h5netcdf xarray cartopy deprecation xmltodict semver notebook nbconvert coverage codecov pytest pytest-cov pytest-xdist pytest-sugar"
