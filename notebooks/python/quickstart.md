...
Loops or iterations as well as conditional statements are key to data processing workflows.
...
This is the basic way to read from and write to text and binary files (there are a lot of other file formats which have specific interfaces - particularly in the radar world: see [file formats supported by wradlib/xradar](../fileio/fileio)).
...
* **IPython**: an interactive **Python shell**, see our article on {ref}`wradlib:jupyter notebooks`.

* **Numpy**: provides powerful **numerical arrays** objects, and routines to
  manipulate them - see our [NumPy intro article](numpyintro)

* **Matplotlib** : visualization and "publication-ready" plots, see related intro [here](mplintro)
